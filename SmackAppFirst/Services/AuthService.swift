...
//                }
    ...
    func userByData (completion: @escaping completionHandler) {
        Alamofire.request("\(FIND_USER_BY_EMAIL)\(userEmail)", method: .get, parameters: nil, encoding: JSONEncoding.default, headers: BEARER_HEADER).response { (response) in
